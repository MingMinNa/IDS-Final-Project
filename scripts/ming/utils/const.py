...
PROJECT_FOLDER = __get_parent_folder(__file__, 4)

# data folder
DATA_FOLDER = os.path.join(PROJECT_FOLDER, 'data')
# Original: PROCESSED_FOLDER = os.path.join(DATA_FOLDER, 'processed') 
PROCESSED_FOLDER = os.path.join(DATA_FOLDER, 'ming') 
RAW_FOLDER = os.path.join(DATA_FOLDER, 'raw')

# model folder
MODEL_FOLDER = os.path.join(PROJECT_FOLDER, 'models', 'ming')

# IMG folder
IMG_FOLDER = os.path.join(PROJECT_FOLDER, 'img', 'ming')
