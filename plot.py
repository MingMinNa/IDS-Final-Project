...
for county in counties:
    # 讀取 CSV 文件
    input_path = f"data/XGB_AQI_result(RE)/XGB_result_{county}.csv"
    input_path = f"data/NN_AQI_result(RE)/NN_result_{county}.csv"
    ...
    for sitename in sitename_list:
        ...
        # 儲存圖片
        filename = f"img/NN/{county}_{sitename}_prediction_plot.png"
